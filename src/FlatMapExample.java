...
public class FlatMapExample {
    ...
    public static void main(String[] args) {
        ...
        List<Car> list1 = Arrays.asList(car1, car2, car3, car4, car5);
        List<Car> list2 = Arrays.asList(car6, car7, car8, car9, car10);


//        Stream<List<Car>> list11 = Stream.of(list1, list2);
//
//        List<Car> collect = list11.flatMap(Collection::stream).collect(Collectors.toList());
//        System.out.println(collect);

        List<List<Car>> list = Arrays.asList(list1, list2);
        List<Car> collect = list.stream().flatMap(Collection::stream).collect(Collectors.toList());
        System.out.println(collect);
