...
public class SortingMultipleFieldsExample {
    public static void main(String[] args) {
        ...
        List<Car> carList = cars.stream().sorted(Comparator.comparingInt(Car::getYear)
                        .thenComparingDouble(Car::getPrice))
                .collect(Collectors.toList());
        System.out.println(carList);

        List<Car> carList1 = cars.stream().sorted(Comparator.comparingInt(Car::getYear)
                .reversed().thenComparingDouble(Car::getPrice))
                .collect(Collectors.toList());
