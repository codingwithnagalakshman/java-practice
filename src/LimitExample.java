...
//        List<Car> collect = cars.stream().skip(2).limit(2).collect(Collectors.toList());
//        System.out.println(collect);

        List<Car> collect = cars.stream().skip(Math.multiplyExact(2, 10)).limit(2).collect(Collectors.toList());
        System.out.println(collect);
    }
}
