...
public class AllMatchExample {
    public static void main(String[] args) {
        ...
        // allMatch
        boolean allMatch = cars.stream().allMatch(car -> car.getPrice() > 30000);
        System.out.println(allMatch);

        //anyMatch
        boolean anyMatch = cars.stream().anyMatch(car -> car.getPrice() > 70000);
        System.out.println(anyMatch);

        //noneMatch
        boolean noneMatch = cars.stream().noneMatch(car -> car.getPrice() > 50000);
