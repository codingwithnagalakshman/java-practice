...
//        List<Car> carList = cars.stream().sorted(Comparator.comparing(Car::getMake, Comparator.reverseOrder())).collect(Collectors.toList());

//        List<Car> carList = cars.stream().sorted(Comparator.comparingDouble(Car::getPrice).reversed()).collect(Collectors.toList());

        List<Car> carList = cars.stream().sorted(Comparator.comparingInt(Car::getYear).reversed()).collect(Collectors.toList());
