...
public class PartitionedByExample {
    public static void main(String[] args) {
        ...
        Map<Boolean, List<Car>> collect = cars.stream().collect(Collectors.partitioningBy(car -> car.getPrice() > 45000));
        System.out.println(collect);

        Map<Boolean, List<Car>> collect1 = cars.stream().collect(Collectors.partitioningBy(car -> car.getYear() == 2023));
